...
describe('TasksService', () => {
    ...
    describe('getAllTasks', () => {
        it('calls TasksRepository.getAllTasks and returns result', async () => {
            ...
            expect(tasksRepository.getAllTasks).toHaveBeenCalledWith(filterDto, mockUser);
        });
    });
    ...
    describe('getTaskById', () => {
        ...
        it('throws an error if not found', async () => {
            ...
            await expect(
                tasksService.getTaskById('abc', mockUser)
    ...
    describe('deleteTask', () => {
        ...
        it('deletes successfully', async () => {
            ...
            await expect(tasksService.deleteTask('1', mockUser)).resolves.not.toThrow();
        });
    });
    ...
    describe('updateTaskStatus', () => {
        it('updates the status and returns task', async () => {
            ...
            const result = await tasksService.updateTaskStatus('abc', TaskStatus.DONE, mockUser);
